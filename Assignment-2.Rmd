...
The 95% confidence interval for the effect of recreational marijuana legalization on murder rate is (`r mj_coef_lb`,`r mj_coef_ub`). This indicates that legalization does not contribute to "reefer madness". If anything, the coefficient is negative suggesting that legalization of marijuana decreases violent crime.
...
We fail to reject the null that marijuana did not increase crime with p values of `r co_pval` for Colorado and `r wa_pval` for Washington. This is because the ratio of PostMSE/PreMSE is low and that implies that crime did not spike post treatment. Altogether this suggests that marijuana legalization does not change murder rates.
